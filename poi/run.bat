...
java -jar target\poi-0.0.1-SNAPSHOT-jar-with-dependencies.jar D:\zhongwei\hyj TestWordTemplate.doc TestExcelOfData.xlsx TestExcelForReplace.xlsx Sheet3 3