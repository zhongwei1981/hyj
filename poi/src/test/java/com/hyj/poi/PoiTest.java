...
public class PoiTest {
	...
	public static boolean changWord(String inputUrl, String outputUrl, Map<String, String> textMap,
		...
		try {
			...
			// 解析替换文本段落对象
			PoiTest.changeText(document, textMap);
			// 解析替换表格对象
			PoiTest.changeTable(document, textMap, tableList);
...
//		// 模板文件地址
//		String inputUrl = "E:\\hyj\\PoiTest\\001.docx";
//		// 新生产的模板文件
//		String outputUrl = "E:\\hyj\\PoiTest\\test.docx";
//
...
//
//		PoiTest.changWord(inputUrl, outputUrl, testMap, testList);
//	}
}
